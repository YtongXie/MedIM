...
from medim.models.backbones.transformer_model import TransModel2d, TransConfig
import math
...
class Decoder2D(nn.Module):
    def __init__(self, in_channels, out_channels, features=[512, 256, 128, 64]):
        ...
        # self.upsample_1 = nn.ConvTranspose2d(features[0], features[0], kernel_size=2, stride=2)
        ...
        # self.upsample_2 = nn.ConvTranspose2d(features[1], features[1], kernel_size=2, stride=2)
        ...
        # self.upsample_3 = nn.ConvTranspose2d(features[2], features[2], kernel_size=2, stride=2)
        ...
        # self.upsample_4 = nn.ConvTranspose2d(features[3], features[3], kernel_size=2, stride=2)

        self.final_out = nn.Conv2d(features[-1], out_channels, 3, padding=1)

    def forward(self, x):
        # x = nn.Upsample(scale_factor=2, mode="nearest")(self.decoder_1(x))
        # x = nn.Upsample(scale_factor=2, mode="nearest")(self.decoder_2(x))
        # x = nn.Upsample(scale_factor=2, mode="nearest")(self.decoder_3(x))
        # x = nn.Upsample(scale_factor=2, mode="nearest")(self.decoder_4(x))
        ...
        # x = self.upsample_1(self.decoder_1(x))
        # x = self.upsample_2(self.decoder_2(x))
        # x = self.upsample_3(self.decoder_3(x))
        # x = self.upsample_4(self.decoder_4(x))
