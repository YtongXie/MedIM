...
from medim.preprocess.utils import extract_mimic_text
import numpy as np
...
def main():
    ...
    for i in range(n):
        ...
        if os.path.exists(os.path.join("/home/ytxie/userdisk2/ytxie/SSL_data/2019.MIMIC-CXR-JPG/", file_path)):
            path_list.append(file_path)
        else:
            delete_list.append(i)

    master_df = master_df.drop(index=master_df.index[delete_list])
